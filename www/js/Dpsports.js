...
.controller('MainController', function ($scope) {
 $scope.sports =  [
   ...
   //{imageSrc: '../img/Angrysports/radioactive.jpg', url: 'https://www.youtube.com/watch?v=ktvTqknDobU'},
  // {imageSrc: '../img/Angrysports/BeforeHeCheats-CarrieUnderwood.png', url: 'https://www.youtube.com/watch?v=WaSy8yy-mr8'},
   //{imageSrc: '../img/Angrysports/148637af895ce6c2fda70078c6fb4457.jpg', url: 'https://www.youtube.com/watch?v=d8ekz_CSBVg'},
  // {imageSrc: '../img/Angrysports/7_Things_(Miley_Cyrus_single_-_cover_art).png', url: 'https://www.youtube.com/watch?v=Hr0Wv5DJhuk'}
